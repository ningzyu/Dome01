...
public class FloatWindowSmallView  extends LinearLayout {
    ...
    public FloatWindowSmallView(Context context) {
        ...
        percentView.setText(MyWinUtil.getUsedPercentValue(context));
    }
    ...
    private void launchRocket() {
        MyWinUtil.removeLauncher(getContext());
    ...
    private void updateViewStatus() {
        if (isPressed && rocketImg.getVisibility() != View.VISIBLE) {
            ...
            MyWinUtil.createLauncher(getContext());
        } else if (!isPressed) {
    ...
    private void openBigWindow() {
        MyWinUtil.createBigWindow(getContext());
        MyWinUtil.removeSmallWindow(getContext());
    }
