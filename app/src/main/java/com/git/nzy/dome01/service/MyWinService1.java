...
import com.git.nzy.dome01.MainActivity;
...
public class MyWinService1 extends Service {
    ...
    private void initView() {
        mWindowView = LayoutInflater.from(getApplication()).inflate(R.layout.launcher, null);
        mPercentTv = (ImageView) mWindowView.findViewById(R.id.launcher_img);
    }
    ...
    private void initClick() {
        ...
        mPercentTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isAppAtBackground(MyWinService1.this)) {
                    Intent intent = new Intent(MyWinService1.this, MainActivity.class);
